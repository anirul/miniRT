...
camera::camera(const vector3& vup, const vector3& vto, const vector3& vpos,
               const float ffov) {
  up = vup;
  to = vto;
  pos = vpos;
...
camera& camera::operator()(const vector3& vup, const vector3& vto,
                           const vector3& vpos, const float ffov) {
  up = vup;
  to = vto;
  pos = vpos;
  fix_perp();
