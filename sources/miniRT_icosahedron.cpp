...
icosahedron::icosahedron() {
  const vertex vb[nbvertex] = {
      ...
      vertex(vector3(-10.0f, -2.0f, 10.0f),
             vector3(0.0f, 1.0f, 0.0f).Normalize(), vector4(1.0f, 1.0f, 0.0f))};
  const int ib[nbindex] = {// icosahedron
                           10, 2, 6, 10, 6, 0, 10, 0, 8, 10, 8, 4, 10, 4, 2, 0,
                           6, 3, 0, 3, 5, 0, 5, 8, 11, 1, 7, 11, 7, 2, 11, 2, 4,
                           11, 4, 9, 11, 9, 1, 1, 9, 5, 1, 5, 3, 1, 3, 7, 2, 7,
                           6, 3, 6, 7, 4, 8, 9, 5, 9, 8,
                           // plane
                           12, 14, 13, 12, 15, 14};
}
